...
const projects: Project[] = [
  {
    id: 1,
    slug: "Sira Self Assessment ",
    title: "Sira Self Assessment",
    category: "Web App",
    shortDescription:
      "the Sira Self Assessment is a web application designed to help users assess their skills and find job opportunities that match their qualifications.",
    description: [
      "The Sira Self Assessment is a comprehensive web application that allows users to evaluate their skills and competencies in various domains. It provides a user-friendly interface for taking assessments, tracking progress, and receiving personalized feedback.",
      "Users can create profiles, take skill assessments, and receive recommendations for job opportunities based on their results. The platform also includes resources for skill development and career advancement.",
      "The application was built with a focus on accessibility and responsiveness, ensuring a seamless experience across devices.",
    ],
    features: [
